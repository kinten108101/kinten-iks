...
namespace Engine
{
    public class buoyancyv3z : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
                ...
                _delta = _rigidbody.transform.up.z;
                _error = _delta;
                ...
                _rigidbody.AddForceAtPosition(forceVector,transform.position + new Vector3(0f,-1f,2f),ForceMode.Force);
